...
#define CTRL_X_CUBE_AI_MODE_CLASS_LIST           {"car_horn","chainsaw","clock_tick","crackling_fire","crying_baby","dog","rain","rooster","sea_waves","sneezing"}
...
#define CTRL_X_CUBE_AI_OOD_THR                   (NoneF)
